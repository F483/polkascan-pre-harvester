...
DB_USERNAME_TEST = os.environ.get("DB_USERNAME_TEST", "root")
DB_PASSWORD_TEST = os.environ.get("DB_PASSWORD_TEST", "root")

DB_CONNECTION_TEST = os.environ.get("DB_CONNECTION_TEST", "mysql+mysqlconnector://{}:{}@{}:{}/{}".format(
...
TYPE_REGISTRY = os.environ.get("TYPE_REGISTRY", "joystream")
